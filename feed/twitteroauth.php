...
class TwitterOAuth {
  ...
  function oAuthRequest($url, $method, $parameters) {
	...
	//print $url;
 print    $request = OAuthRequest::from_consumer_and_token($this->consumer, $this->token, $method, $url, $parameters);
  $request ='http://twitter.com/statuses/update.xml?oauth_consumer_key=NqTrtlSKiPh5AshpLttpQ&oauth_nonce=dd55e975384494661ac866f0783a62b7&oauth_timestamp=1262868646&oauth_token=40041578-AUcJt2Da0oL1E4bnUSlWqJT3iHIsXQDiB2kzrWeuh&oauth_version=1.0a';  
  	exit;
  ...
  //$postfields = $postfields."&status=ssenthil";
 // $url= $url."&status=ssenthil";
  //  print $url;
  //print $method;
  //print $postfields;
    $ci = curl_init();
