<?php
if (substr_count($_SERVER['HTTP_ACCEPT_ENCODING'], 'gzip'))  { if (function_exists('ob_gzhandler') && !ini_get('zlib.output_compression'))  ob_start('ob_gzhandler'); } else ob_start(); 
session_start();
...
<title><?php echo $metadata_selected['title'] ; ?></title>
	...
	<link rel="shortcut icon" type="image/x-icon" href="http://www.twitjix.com/favicon.ico">
...
<div class="main_container">
	...
	<div class="banner_area">
     ...
     <div style=" padding:0 0 0 10px; float:left;"><a href="<?php  try{ print $twitterObj->getAuthenticateUrl(); } catch (Exception $e) {}; ?>"><img src="<?php echo FACEBX_PATH.'sign_in_twitter.gif' ?>" alt="Sign in with Twitter" /></a></div>
			<div class="clear"></div>
				...
				<div class="video">
	<a  
			 href="http://twitjix.com/twittac-video.flv"  
			 style="display:block;width:336px;height:212px;padding:0 0 0 10px;"  
			 id="player"> 
		</a> 
		<script>
			/*flowplayer("player", "flowplayer-3.2.2.swf");*/
			flowplayer("player", { src: 'flowplayer-3.2.2.swf', cachebusting: true }, {  
			 
			clip: { autoPlay: false, autoBuffering: true,url: 'http://twitjix.com/twittac-video.flv'},  
/*			 
			plugins: {  
				 controls: { 
					tooltips: { buttons: true, tooltipColor: '#1FADFF'},  
						 
					autoHide: 'always', hideDelay: 3000, backgroundColor: '#663300', bufferColor: '#555555',  
					bufferGradient: 'low', buttonColor:'#555555', buttonOverColor: '#6E6E6E', sliderColor: '#521E00',  
					sliderGradient: [0.3, 0.0, 0.3], volumeSliderColor: '#521E00', volumeSliderGradient: [0.3, 0.0, 0.3],  
					 
					canvas: {backgroundColor: '#0086D3', backgroundGradient: [0.6, 0.0], border: '3px solid #0086D3'} 
