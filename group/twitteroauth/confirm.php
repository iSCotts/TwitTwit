...
try {
  ...
  //  $params     =   array('status' => $status);
    ...
    $do_dm      =   simplexml_load_string($to->oAuthRequest('http://twitter.com/statuses/update.xml', 'POST',array('status' => 'Test OAuth update. #testoauth')));
	$dt=date('Y-m-d H:i:s');
	addapistatinfo("oauthconfirm","statuses/update",$token, $dt); 
