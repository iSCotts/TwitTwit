...
function submitDetails(){
	...
	{
		$('#error_keyword').html('<img src="../images/loading.gif" style="padding-left:340px"/>');
	}
	else
	{
		$("#tlTable").append('<span class="error" id="error_keyword" ><img src="../images/loading.gif" style="padding-left:340px"/></span>');
	}
