...
ddaccordion.init({
	...
	togglehtml: ["suffix", "<img src='../images/minus.png' class='statusicon' title='Campaign Statistics' />", "<img src='../images/plus.png' class='statusicon' />"], //Additional HTML added to the header when it's collapsed and expanded, respectively  ["position", "html1", "html2"] (see docs)
