...
<tr>
<td colspan="5" align="center"><strong>View Affiliate Request</strong></td>
 </tr>
<tr>
...
<?php
$getaffiliatedetails = "SELECT * FROM ta_affiliate_request WHERE Status ='' ";
$getaffiliatedetailsresult  = runQuery($getaffiliatedetails);
  if( count($getaffiliatedetailsresult) >=1 )
  {
	...
	<td><a href="viewaffiliaterequest.php?id=<?php echo $getaffiliatedetailsresult[$r]["id"]; ?>&act=a">Approve</a></td>
