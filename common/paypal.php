...
//	$API_UserName = urlencode('my_api_username');
	$API_UserName = urlencode('lijumo_1260789370_biz_api1.yahoo.com');
//	$API_Password = urlencode('my_api_password');
	$API_Password = urlencode('1260789379');
//	$API_Signature = urlencode('my_api_signature');
	$API_Signature = urlencode('AdcbGIt9vh5iz1TY0hGRpQE2HMwpAJa0S3yZeQuRg8M9gwFbUH39Hanz');
