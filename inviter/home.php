...
var userWidth = screen.availWidth;
    ...
    var leftPos;
    var topPos;
    var popW = 620;   //set width here
    var popH = 360;   //set height here
	...
	//newwindow=window.open(url,'name','height=360,width=620');
	if (window.focus) {newwindow.focus()}
	return false;
}
<?php if(isset($_SESSION["mailid"] )&&($_SESSION["mailid"]!="" ))
{?>
window.onload =popitup('emailpopup.php'); 
<?php
}
?>
// -->
